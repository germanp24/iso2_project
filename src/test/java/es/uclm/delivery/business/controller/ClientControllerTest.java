...
import es.uclm.delivery.business.controller.ClientController;
...
@WebMvcTest(ClientController.class)
    ...
    public class ClientControllerTest {
        ...
        @Test
        public void testClientDAOInjection() throws Exception {
            Client client = new Client("12345678A", "Juan", "Pérez", "Gómez", null);
        ...
        @Test
        public void testClientHome() throws Exception {
            Client client = new Client("12345678A", "Juan", "Pérez", "Gómez", null);
            when(clientDAO.findByUsuary_Email("test@example.com")).thenReturn(java.util.Optional.of(client));
        ...
        @Test
        public void testClientSubmit() throws Exception {
            Client client = new Client("12345678A", "Juan", "Pérez", "Gómez", null);
            Usuary usuary = new Usuary("password123", "test@example.com", "CLIENT");
